...
@interface HQNearOfficeViewController ()<UITableViewDelegate,UITableViewDataSource,BMKPoiSearchDelegate>
{
...
@implementation HQNearOfficeViewController
...
- (void)onGetPoiResult:(BMKPoiSearch*)searcher result:(BMKPoiResult*)poiResultList errorCode:(BMKSearchErrorCode)error
{
    ...
    for (BMKPoiInfo *info in _dataArray) {
        NSLog(@"%@",info.name);
        NSLog(@"%@",info.address);
    }
}
